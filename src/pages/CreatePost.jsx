...
const CreatePost = () => {
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            navigate("/post/posts/" + res.data._id);
        } catch (err) {
            ...
            <div className="center-container">
                <div className="form-container">
                    ...
                    <form className="w-full flex flex-col space-y-4 md:space-y-8 mt-4" onSubmit={handleCreate}>
                        <input onChange={(e) => setTitle(e.target.value)} type="text" placeholder="Enter post title" className="px-4 py-2 outline-none" value={title} />
                        ...
                        <textarea onChange={(e) => setDesc(e.target.value)} rows={15} cols={30} className="px-4 py-2 outline-none" placeholder="Enter post description" value={desc} />
